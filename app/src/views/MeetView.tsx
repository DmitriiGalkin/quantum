...
export default function MeetPage() {
    ...
    const onDeleteUserMeet = (userMeet: UserMeet) => deleteMeetUser.mutateAsync(userMeet).then(() => refetch()) // isAuth ? deleteMeetUser.mutateAsync(meet.id).then(() => refetch()) : openLogin()
                ...
                <div style={{ position: "relative"}}>
                    <div className={classes.container}>
                                            ...
                                            {meet.userMeets?.map((userMeet) => (
                                                <Stack spacing={3} direction="row" alignItems="flex-start">
                                                    ...
                                                    {!userMeet.started && (
                                                        <div
                                                            style={{ fontSize: 11, fontWeight: 500, padding: '3px 9px', color: '#7139FF', border: '1px solid #7139FF', borderRadius: 8, alignItems: 'center', justifyContent: 'center', textTransform: 'uppercase' }}
                                                            onClick={() => onStarted(userMeet)}
                                                        >
                                                            Пришел
                                                        </div>
                                                    )}
                                                    {userMeet.started && !userMeet.stopped && (
                                                        <div
                                                            style={{ fontSize: 11, fontWeight: 500, padding: '3px 9px', color: '#7139FF', border: '1px solid #7139FF', borderRadius: 8, alignItems: 'center', justifyContent: 'center', textTransform: 'uppercase' }}
                                                            onClick={() => onStopped(userMeet)}
                                                        >
                                                            Ушел
                                                        </div>
                                                    )}
                        ...
                        <div style={{ paddingTop: 20, marginLeft: -8, marginRight: -8 }}>
                            {meet.userMeet ? (
                                <Button onClick={() => meet?.userMeet && onDeleteUserMeet(meet.userMeet)} variant="outlined">
                                    Покинуть встречу
                                </Button>
                            ) : (
                                <Button onClick={onCreateUserMeet}>
                                    Участвовать
                                </Button>
                            )}
                        </div>
