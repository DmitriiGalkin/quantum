...
export const useProjects = (params?: ProjectFilter): UseQueryResult<Project[]> => useQuery(['projects', params?.self, params?.deleted, params?.userId], () => service.get(`/projects`, { params }))
