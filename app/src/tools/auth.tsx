...
export const GOOGLE_REDIRECT_URI = 'http://localhost:3000/callback' // 'https://selfproject.ru/callback'; // Адрес редиректа после авторизации 'http://localhost:3000/callback'
