...
export default function LoginPage() {
    ...
    const onClickSave = () => login({ email, password })

    return (
        <div className={classes.container}>
            <div style={{ padding: 15 }} className={classes.content}>
                ...
                <Box style={{ paddingTop: 50 }}>
                    <Stack spacing={4}>
                        ...
                        <Button href={uri} variant="outlined">
                            <svg width="48" height="48" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                                <g>
