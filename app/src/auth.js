...
// Client ID з кроку #3
export const GOOGLE_CLIENT_ID = '804980223837-9e350rj8p8glgbqel5c5rmh6jafnf1u2.apps.googleusercontent.com';

// Client Secret з кроку #3
export const GOOGLE_CLIENT_SECRET = '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';
...
export const uri = GOOGLE_AUTH_URI + '?' + http_build_query(parameters)
