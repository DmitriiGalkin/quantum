        ...
        <Stack spacing={1} direction="row" justifyContent="space-between">
            {week.map(({id, dayOfWeekValue, day, active, meetsLength}, index) =>
                <Stack spacing={3} direction="column" key={day} alignItems="center" onClick={() => {
                    ...
                    <div style={{position: 'relative', paddingTop: '100%', width: '100%', borderRadius: 100, backgroundColor: active ? '#394F63' : '#F5F5F5', color: active ? '#ffffff' : '#394F63',
                        border: '1px solid rgba(57, 79, 99, 0.1)', boxShadow: '0px 2.769230604171753px 12.923076629638672px 0px rgba(0, 0, 0, 0.05)' }}>
