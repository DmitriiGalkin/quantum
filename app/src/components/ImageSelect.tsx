        ...
        {onAdd && (
          <Grid xs={3}>
            <div onClick={onAdd}>
                ...
                <div className={classes.image} style={{ border: `2px dashed #070707` }}>
                  <div style={{ margin: '12px auto', width: 35 }}>
                    <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M17.5001 2.0581L17.5001 32.9418"
                        stroke="#070707"
                        strokeWidth="2.68302"
                        strokeLinecap="round"
                      />
                      <path
                        d="M2.05811 17.5001L32.9418 17.5001"
                        stroke="#070707"
                        strokeWidth="2.68302"
                        strokeLinecap="round"
                      />
              ...
              <div style={{ paddingTop: 11, textOverflow: 'ellipsis', overflow: 'hidden', textAlign: 'center' }}>
                {label}
              </div>
            </div>
          </Grid>
            ...
            >
              <div className={classes.blockInner}>
                <img
                  ...
                  style={{ outline: `3px solid ${selected?.id === item?.id ? COLOR_PRIMARY : 'transparent'}` }}
                />
              </div>
              <div
                style={{
