                    ...
                    <Stack spacing={2} direction="row" justifyContent="space-between" style={{ width: '100%' }} alignItems="center">
                        ...
                        <Stack spacing={4} direction="row" justifyContent="space-between" alignItems="center">
                            <div onClick={toggleMap} style={{ display: 'flex' }}>
                                <div style={{ outline: '2px solid white', borderTopLeftRadius: 10, borderBottomLeftRadius: 10, backgroundColor: map ? COLOR : 'white', padding: '8px 12px', display: 'flex' }}>
                                ...
                                <div style={{ outline: '2px solid white', borderTopRightRadius: 10, borderBottomRightRadius: 10, backgroundColor: map ? 'white' : COLOR, padding: '8px 12px', display: 'flex' }}>
