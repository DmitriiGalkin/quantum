                    ...
                    <Stack spacing={2} direction="row" justifyContent="space-between" style={{ width: '100%' }} alignItems="center">
                        ...
                        <Stack spacing={4} direction="row" justifyContent="space-between" alignItems="center">
                            <div onClick={toggleMap} style={{ display: 'flex' }}>
                                <div style={{ outline: '2px solid white', borderTopLeftRadius: 10, borderBottomLeftRadius: 10, backgroundColor: map ? '#FFA028' : 'white', padding: '8px 12px', display: 'flex' }}>
                                    <svg width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <rect x="0.75" y="0.75" width="22.1786" height="14.5" rx="3.25" stroke={map ? 'white' : "#FFA028"} strokeWidth="1.5"/>
                                        <mask id="path-2-inside-1_542_1158" fill="white">
                                            <rect x="4" y="3.42859" width="7.28571" height="9.14286" rx="1"/>
                                        </mask>
                                        <rect x="4" y="3.42859" width="7.28571" height="9.14286" rx="1" stroke={map ? 'white' : "#FFA028"} strokeWidth="3" mask="url(#path-2-inside-1_542_1158)"/>
                                        <path d="M19.1121 4.28217L14.2075 4.28217" stroke={map ? 'white' : "#FFA028"} strokeWidth="1.5" strokeLinecap="round"/>
                                        <path d="M19.1121 11.8528L14.2075 11.8528" stroke={map ? 'white' : "#FFA028"} strokeWidth="1.5" strokeLinecap="round"/>
                                        <path d="M16.6599 7.08667H14.2076" stroke={map ? 'white' : "#FFA028"} strokeWidth="1.5" strokeLinecap="round"/>
                                    </svg>
                                </div>
                                <div style={{ outline: '2px solid white', borderTopRightRadius: 10, borderBottomRightRadius: 10, backgroundColor: map ? 'white' : "#FFA028", padding: '8px 12px', display: 'flex' }}>
