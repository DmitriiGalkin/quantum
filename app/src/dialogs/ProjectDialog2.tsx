...
function ProjectDialog2() {
  ...
  return (
    <>
      ...
      <EditProject name={'editProject' + project.id} projectId={project.id} open={edit} onClose={onCloseEditProject} onDeleteProject={back} />
      <EditMeet defaultProjectId={project.id} open={createMeet} onClose={onCloseCreateMeet} />
    </>
  )
}

export default withDialog(ProjectDialog2)
