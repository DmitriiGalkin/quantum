            ...
            <div>
              <div
                style={{
                  ...
                  display: 'flex',
                  width: 60,
                  backgroundImage: `url(${meet.project.image})`,
                      ...
                      <AvatarGroup max={4}>
                        {meet.visits?.map((visit) => {
                          return visit.user ? (
                            <Avatar
                              key={visit.user.id}
                              alt={visit.user.title}
                              src={visit.user.image}
                              sx={{
                                width: 21,
                                height: 21,
                                borderColor: `${visit.started && !visit.stopped ? COLOR : COLOR_DEFAULT} !important`,
                              }}
                            />
                          ) : null
                        })}
