...
const pages = [
    { title: 'Участникам', path: '/for-user' },
    { title: 'Мастерам', path: '/for-master' },
    { title: 'Пространствам', path: '/for-place' },
];
const settings = [
    { title: 'Profile', path: '/for-user' },
    { title: 'Account', path: '/for-user' },
    { title: 'Пространства', path: '/profile/places' },
    { title: 'Logout', path: '/for-user' },
];
